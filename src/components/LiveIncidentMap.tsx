            ...
            <div className="mt-3 flex gap-2">
              {fullScreen && (
                <button
                  ...
                  className="flex-1 py-1.5 px-2.5 bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
