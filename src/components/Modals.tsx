    ...
    <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md">
      <div className={`border rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto scrollbar-thin animate-in zoom-in-95 duration-200 ${
                      ...
                      <div className="flex items-center gap-2">
                        {v.isAssigned ? (
                          ...
                          <button
                            ...
                            className="px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-[11px] font-bold flex items-center gap-1 shadow-sm cursor-pointer"
                          >
        ...
        <div className={`p-4 border-t flex justify-between items-center ${
          ...
          <button
            onClick={onClose}
            className="px-5 py-2 text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white rounded-xl shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all cursor-pointer"
          >
            Done
          </button>
        </div>
