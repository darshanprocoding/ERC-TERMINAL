...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!trimmedUser || !trimmedPass) {
      setError('Please enter commander callsign and passkey.');
      return;
    }
    ...
    setTimeout(() => {
      if (trimmedUser.toLowerCase() === 'watchdogs' && trimmedPass === 'guruchan') {
        ...
        setIsLoading(false);
        setError('Access Denied: Invalid credentials or insufficient clearance level.');
      }
    }, 700);
  };

  return (
    <div className="min-h-screen bg-[#070b14] flex items-center justify-center p-4 relative overflow-hidden font-sans select-none">
      ...
      {/* Main Login Card */}
      <div className="relative z-10 w-full max-w-md bg-[#0a0f1d]/95 backdrop-blur-xl border border-[#1e2c45] rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.8)] overflow-hidden">
        ...
        <div className="p-7 sm:p-9">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            <div className="relative mb-3">
              <div className="w-16 h-16 rounded-2xl bg-[#0e172a] border-2 border-[#253859] flex items-center justify-center text-red-500 shadow-[0_0_25px_rgba(239,68,68,0.25)]">
            ...
            <div className="mt-3.5 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#111c30] border border-[#203456] text-[11px] text-blue-300 font-mono">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              type="submit"
              disabled={isLoading || authSuccess}
              className={`w-full mt-2 py-3 px-4 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-lg cursor-pointer ${
                authSuccess
