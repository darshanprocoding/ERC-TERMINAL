          ...
          <div className="p-5 sm:p-6 space-y-5 overflow-y-auto">
            ...
            <form onSubmit={handleStartDialing} className="space-y-4">
              ...
              <div className="flex gap-2.5 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                >
                  <PhoneCall size={14} />
            ...
            <div className={`p-4 border-t space-y-3 ${
              ...
              >
                ...
                <button
                  ...
                  className="px-3 py-2 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white rounded-xl text-xs font-bold transition-colors flex items-center gap-1 cursor-pointer shadow-sm"
                >
                  <Send size={13} />
                  <span>Transmit</span>
                </button>
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                ...
                <button
                  type="button"
                  onClick={onEndCall}
                  className="p-3 bg-red-600 hover:bg-red-500 text-white rounded-xl font-bold transition-all shadow-sm flex items-center gap-1.5 cursor-pointer"
